	...
	try {
		...
		if (storedRoom) {
			...
			return {
				...
				error: null,
				meta: {
					title: `Join ${room.name} - Connect Four | Two Players`,
					description: `Join "${room.name}" and play Connect Four! Drop discs and connect four in a row to win.`,
					imageUrl: 'https://placehold.co/1200x630/18181b/71717a?text=Connect+Four',
					url: url.href
				}
			};
		}
